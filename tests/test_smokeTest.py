...
class TestSmokeTest():
  ...
  def test_adminPage(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("imposter")
    self.driver.find_element(By.ID, "password").send_keys("sus")
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("Bizzyness")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Owner")
    self.driver.find_element(By.NAME, "submit").click()
    elements = self.driver.find_elements(By.NAME, "email")
    assert len(elements) > 0
  
  def test_spotlightsandCalltoAction(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1552, 832)
    ...
    assert(self.vars["url"] == "http://127.0.0.1:5500/teton/1.6/join.html")
